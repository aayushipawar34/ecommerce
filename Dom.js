...
// Right Side: Order Summary
    ...
    placeOrderBtn.addEventListener("click", function () {
        ...
        if (selectedQuantity > 0) {
            let orderDetails = `Order Confirmed!\n\nProduct: ${product.title}\nQuantity: ${selectedQuantity}\nPayment: ${selectedPayment}\n\nThank you for your purchase! 🎉`; // Thank you message added here
            alert(orderDetails);
...
// buyNow.addEventListener("click",function checkUserAndAddToCart(title) {
//     let isLoggedIn = localStorage.getItem("currentUser"); // Check current session login status
